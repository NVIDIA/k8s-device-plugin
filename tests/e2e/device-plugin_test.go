...
var _ = Describe("GPU Device Plugin", Ordered, Label("gpu", "e2e", "device-plugin"), func() {
	...
	When("deploying k8s-device-plugin", Ordered, Label("serial"), func() {
		It("should create nvidia.com/gpu resource", Label("gpu-resource"), func(ctx SpecContext) {
		...
		It("should run GPU jobs", Label("gpu-job"), func(ctx SpecContext) {
