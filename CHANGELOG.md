# NVIDIA Device plugin Changelog

### Version v0.14.1

- Migrate GPU Feature Discovery to Device Plugin repo.
- The GFD container is built from the device plugin repository and published as part of the release process.
- The GFD version will match the Device Plugin version. This means that the next GFD release will be 0.14.x and not 0.8.0.
