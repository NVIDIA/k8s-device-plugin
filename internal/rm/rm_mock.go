...
//				panic("mock out the GetImexChannelIDs method")
//			},
...
type ResourceManagerMock struct {
	...
	// GetImexChannelIDsFunc mocks the GetImexChannelIDs method.
	GetImexChannelIDsFunc func() []string
	...
	calls struct {
		...
		// GetImexChannelIDs holds details about calls to the GetImexChannelIDs method.
		GetImexChannelIDs []struct {
		}
	...
	lockGetImexChannelIDs      sync.RWMutex
...
// GetImexChannelIDs calls GetImexChannelIDsFunc.
func (mock *ResourceManagerMock) GetImexChannelIDs() []string {
	callInfo := struct {
	}{}
	mock.lockGetImexChannelIDs.Lock()
	mock.calls.GetImexChannelIDs = append(mock.calls.GetImexChannelIDs, callInfo)
	mock.lockGetImexChannelIDs.Unlock()
	if mock.GetImexChannelIDsFunc == nil {
		var (
			stringsOut []string
		)
		return stringsOut
	}
	return mock.GetImexChannelIDsFunc()
}

// GetImexChannelIDsCalls gets all the calls that were made to GetImexChannelIDs.
// Check the length with:
//
//	len(mockedResourceManager.GetImexChannelIDsCalls())
func (mock *ResourceManagerMock) GetImexChannelIDsCalls() []struct {
} {
	var calls []struct {
	}
	mock.lockGetImexChannelIDs.RLock()
	calls = mock.calls.GetImexChannelIDs
	mock.lockGetImexChannelIDs.RUnlock()
	return calls
}
